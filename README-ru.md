...
│   ├── runner/                # модули запуска исполнения
...
│   ├── prompt/                # сборка системных промптов (Composer)
│   ├── providers/             # провайдеры инструментов (Sandbox, Tavily, Delegation, и т.д.)
...
│   ├── thoughts.rs            # генерация аналитических мыслей
...
│   └── mod.rs
├── llm/                       # интеграции с провайдерами LLM (OpenAI, Zai, и т.д.)
...
├── html-report.md             # генерация HTML-отчетов
...
├── blueprints/                # планы реализации функций
├── docs/                      # подробные спецификации компонентов
├── bugs/                      # отслеживание ошибок
└── done/                      # завершенные архитектурные задачи
