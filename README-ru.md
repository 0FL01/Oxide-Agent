...
*   **🤖 Режим Агента (Agent Mode):**
    ...
    *   **🎯 Система навыков (Skills):** RAG-система с embeddings для автоматического предоставления релевантного контекста из markdown-документов (8 навыков: core, ffmpeg-conversion, file-hosting, file-management, html-report, task-planning, video-processing, web-search).
