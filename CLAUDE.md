...
## 📦 Доставка файлов агентом
- **До 50 МБ**: используйте `send_file_to_user`.
- **От 50 МБ до 1 ГБ**: переходите на `upload_file` (Litterbox).
- **Больше 1 ГБ**: задача невыполнима — честно сообщите пользователю.
