...
impl ContentBuilder {
    ...
    /// Restricts function calling to the provided function names.
    pub fn with_allowed_function_names<I, S>(mut self, names: I) -> Self
    where
        I: IntoIterator<Item = S>,
        S: Into<String>,
    {
        let function_calling_config = self
            .tool_config
            .get_or_insert_with(Default::default)
            .function_calling_config
            .get_or_insert_with(|| FunctionCallingConfig {
