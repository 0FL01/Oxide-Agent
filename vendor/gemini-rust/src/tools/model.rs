...
pub struct FunctionCall {
    /// Provider-generated correlation id for matching function responses to calls.
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl FunctionCall {
    ...
    /// Create a new function call with a provider correlation id.
    pub fn with_id(
        name: impl Into<String>,
        args: serde_json::Value,
        id: impl Into<String>,
    ...
    /// Create a new function call with both provider id and thought signature.
    pub fn with_id_and_thought_signature(
        name: impl Into<String>,
        args: serde_json::Value,
        id: impl Into<String>,
        thought_signature: impl Into<String>,
...
pub struct FunctionResponse {
    /// Provider-generated correlation id that matches the corresponding function call.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    /// The name of the function
    pub name: String,
...
impl FunctionResponse {
    ...
    /// Create a new function response with a provider correlation id.
    pub fn with_id(
        name: impl Into<String>,
    ...
    /// Create a new function response from a serializable type with a provider id.
    pub fn from_schema_with_id<Response>(
        name: impl Into<String>,
        response: Response,
        id: impl Into<String>,
    ) -> Result<Self, serde_json::Error>
    ...
    /// Create a new function response from a JSON string with a provider id.
    pub fn from_str_with_id(
        name: impl Into<String>,
        response: impl Into<String>,
        id: impl Into<String>,
    ) -> Result<Self, serde_json::Error> {
...
pub struct FunctionCallingConfig {
    ...
    /// Optional allowlist of function names the model may call.
    #[serde(skip_serializing_if = "Option::is_none")]
