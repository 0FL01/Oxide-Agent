...
fn test_settings(manager_users: Option<&str>) -> Arc<BotSettings> {
    Arc::new(BotSettings::new(
        ...
        TelegramSettings {
            ...
            telegram_allowed_users_str: Some("77 88".to_string()),
            telegram_manager_allowed_users_str: manager_users.map(str::to_string),
...
fn manager_default_chat_id_is_restricted_to_configured_manager_home() {
    let settings = Arc::new(BotSettings::new(
        ...
        TelegramSettings {
            ...
            telegram_manager_allowed_users_str: Some("88".to_string()),
