...
pub(crate) const DEFAULT_WEB_VOICE_TRANSCRIPTION_MAX_MB: u64 = 25;
...
pub(crate) fn web_voice_transcription_limit_mb() -> u64 {
    web_u64_env("OXIDE_WEB_VOICE_TRANSCRIPTION_MAX_MB")
        .unwrap_or(DEFAULT_WEB_VOICE_TRANSCRIPTION_MAX_MB)
}
