...
pub enum AgentMessageKind {
    ...
    Summary,
    /// Deterministic handoff snapshot preserved after post-run cleanup.
    Breadcrumb,
...
/// Deterministic handoff snapshot preserved in hot memory after post-run cleanup.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Default)]
...
pub struct RebuildOutcome {
    ...
    /// Whether a deterministic breadcrumb entry was inserted or refreshed.
    pub inserted_breadcrumb: bool,
